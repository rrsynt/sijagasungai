...
Ambil screenshot dari demo yang live (tampilan mobile lebih baik, karena PWA),
simpan ke docs/screenshots/, lalu hapus tanda komentar ini.

| Identifikasi AI | Peta Sebaran |
|---|---|
| ![Identifikasi AI](docs/screenshots/01-identifikasi.png) | ![Peta Sebaran](docs/screenshots/02-peta.png) |

| Beranda | Pemanfaatan Ekonomi |
|---|---|
| ![Beranda](docs/screenshots/03-beranda.png) | ![Pemanfaatan Ekonomi](docs/screenshots/04-ekonomi.png) |
-->
